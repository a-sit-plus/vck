...
class OidvciCodeFlowTest : FreeSpec({
    ...
    "request one credential, using scope" {
        ...
        JwsSigned.deserialize<VerifiableCredentialJws>(serializedCredential, VerifiableCredentialJws.serializer(), vckJsonSerializer).getOrThrow()
    ...
    "request credential in SD-JWT, using scope" {
        ...
        val sdJwt = JwsSigned.deserialize<VerifiableCredentialSdJwt>(serializedCredential.substringBefore("~"), VerifiableCredentialSdJwt.serializer())
            .getOrThrow().payload
