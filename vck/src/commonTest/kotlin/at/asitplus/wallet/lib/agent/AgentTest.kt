...
val AgentTest by testSuite {
    ...
    withFixtureGenerator {
        ...
        "presex: simple walk-through success" { it ->
        ...
        "presex: wrong keyId in presentation leads to error" { it ->
            it.holder.storeCredential(
                it.issuer.issueCredential(
                    DummyCredentialDataProvider.getCredential(
                        it.holderKeyMaterial.publicKey,
        ...
        "presex: getting credentials when there are no credentials stored" { it ->
        ...
        "presex: getting credentials when the issuer has revoked them" { it ->
        ...
        "presex: building presentation without necessary credentials" { it ->
        ...
        "presex: valid presentation is valid" { it ->
            val credentials = it.issuer.issueCredential(
                DummyCredentialDataProvider.getCredential(
                    it.holderKeyMaterial.publicKey,
                    ConstantIndex.AtomicAttribute2023,
        ...
        "presex: valid presentation is valid -- some other attributes revoked" { it ->
            val credentials = it.issuer.issueCredential(
                DummyCredentialDataProvider.getCredential(
                    it.holderKeyMaterial.publicKey,
                    ConstantIndex.AtomicAttribute2023,
        ...
        "dcql: simple walk-through success" { it ->
            it.holder.storeCredential(
                it.issuer.issueCredential(
                    DummyCredentialDataProvider.getCredential(
                        it.holderKeyMaterial.publicKey,
        ...
        "dcql: wrong keyId in presentation leads to error" { it ->
            it.holder.storeCredential(
                it.issuer.issueCredential(
                    DummyCredentialDataProvider.getCredential(
                        it.holderKeyMaterial.publicKey,
        ...
        "dcql: building presentation without necessary credentials" { it ->
        ...
        "dcql: valid presentation is valid" { it ->
            val credentials = it.issuer.issueCredential(
                DummyCredentialDataProvider.getCredential(
                    it.holderKeyMaterial.publicKey,
                    ConstantIndex.AtomicAttribute2023,
        ...
        "dcql: valid presentation is valid -- some other attributes revoked" { it ->
            val credentials = it.issuer.issueCredential(
                DummyCredentialDataProvider.getCredential(
                    it.holderKeyMaterial.publicKey,
                    ConstantIndex.AtomicAttribute2023,
