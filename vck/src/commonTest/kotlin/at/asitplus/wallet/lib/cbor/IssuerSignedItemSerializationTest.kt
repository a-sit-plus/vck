...
val IssuerSignedItemSerializationTest by testSuite {
    ...
    withFixtureGenerator {
        ...
        /**
         * Decoded test vector contains
         * `{"status": {
         *      "status_list": {"idx": 4881, "uri": "https://issuer.eudiw.dev/token_status_list/EU/eu.europa.ec.eudi.pid.1/bb1137e0-fe1e-44db-9285-de7ed8c2d10e"},
         *      "identifier_list": {"id": "4881", "uri": "https://issuer.eudiw.dev/identifier_list/EU/eu.europa.ec.eudi.pid.1/bb1137e0-fe1e-44db-9285-de7ed8c2d10e"}}`
         *  with id encoded as str instead of bstr -> Serialization Error!
         *
         *        6F                                # text(15)
         ...
         *          62                             # text(2)
         *             6964                        # "id"
         *          64                             # text(4) -> should be Bstr i.e. bytes(.)!
         *             34383831                    # "4881"
         *          63                             # text(3)
         *             757269                      # "uri"
         *          78 68                          # text(104)
         *
         *  TODO: New test vec or some workaround for interop event
         */
...
//        """.trimIndent().decodeToByteArray(Base64UrlStrict).encodeToString(Base16Strict)
//
