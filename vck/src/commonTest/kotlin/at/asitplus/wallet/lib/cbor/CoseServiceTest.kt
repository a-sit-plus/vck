...
val CoseServiceTest by testSuite {
    ...
    withFixtureGenerator {
        ...
        "signed object with pseudo-random bytes can be verified" { it ->
        ...
        "mac object with pseudo-random bytes can be verified" { it ->
            val parameterSerializer = ByteArraySerializer()
            val payloadToUse = "This is the content: ".encodeToByteArray() + it.randomPayload
        ...
        "signed object with random bytes can be verified" { it ->
            val parameterSerializer = ByteArraySerializer()
            val signed = it.signCose(
        ...
        "maced object with random bytes can be verified" { it ->
            val parameterSerializer = ByteArraySerializer()
            val maced = it.macCose(
                protectedHeader = null,
        ...
        "signed object with MSO payload can be verified" { it ->
        ...
        "maced object with MSO payload can be verified" { it ->
            val parameterSerializer = MobileSecurityObject.serializer()
            val mso = MobileSecurityObject(
                version = "1.0",
                digestAlgorithm = "SHA-256",
        ...
        "signed object with null payload can be verified" { it ->
        ...
        "maced object with null payload can be verified" { it ->
            val parameterSerializer = NothingSerializer()
        ...
        "signed object with random bytes, transported detached, can be verified" { it ->
            val parameterSerializer = ByteArraySerializer()
        ...
        "maced object with random bytes, transported detached, can be verified" { it ->
            val parameterSerializer = ByteArraySerializer()
