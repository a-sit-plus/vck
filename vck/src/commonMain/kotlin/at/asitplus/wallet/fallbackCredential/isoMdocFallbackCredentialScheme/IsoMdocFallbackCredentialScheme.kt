...
data class IsoMdocFallbackCredentialScheme(override val isoDocType: String? = null, override val isoNamespace: String? = isoDocType) : ConstantIndex.CredentialScheme {
