 ...
 *
 *  Note: JWT NumericDate holds a double, which is big enough to hold any currently interesting
 *  instant with millisecond precision. No need to define a new numeric date format.
 */
