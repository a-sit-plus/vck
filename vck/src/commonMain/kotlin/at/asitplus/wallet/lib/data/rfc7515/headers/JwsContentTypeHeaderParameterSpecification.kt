...
import at.asitplus.wallet.lib.data.rfc7515.primitives.CompactApplicationMediaTypeSerializer
 ...
 *    "example;part="1/2"".
 */
object JwsContentTypeHeaderParameterSpecification : JwsHeaderParameterSpecification {
    const val NAME = "cty"

    interface ClaimProvider {
        @Serializable(with = CompactApplicationMediaTypeSerializer::class)
        @SerialName(NAME)
        val cty: String?
    }

    val JwsHeaderParameterSpecification.Companion.cty: JwsContentTypeHeaderParameterSpecification
        get() = JwsContentTypeHeaderParameterSpecification
}
