...
data class HttpRequestMessage(
    override val controlData: HttpRequestMessageControlData,
    override val headers: List<HttpFieldLine> = listOf(),
    override val content: ByteArray = ByteArray(0),
    override val trailers: List<HttpFieldLine> = listOf(),
) : HttpMessage {
...
data class HttpResponseMessage(
    override val controlData: HttpResponseMessageControlData,
    override val headers: List<HttpFieldLine> = listOf(),
    override val content: ByteArray = ByteArray(0),
    override val trailers: List<HttpFieldLine> = listOf(),
) : HttpMessage {
