...
object StatusListTokenValidator {
    ...
    fun validateStatusListTokenPayloadClaims(
        ...
        statusListTokenPayload.expirationTime?.isInvalid(isInstantInThePast)?.ifTrue {
    ...
    ): TokenStatus = statusList.toStatusListView(zlibService).getOrNull(statusListInfo.index.toLong())
