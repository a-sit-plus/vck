...
import at.asitplus.wallet.lib.data.rfc.tokenStatusList.CompressedStatusList
...
internal data class JsonSerializableCompressedTokenStatusList(
    ...
    fun toCompressedStatusList() = CompressedStatusList(
    ...
    companion object {
        internal fun CompressedStatusList.toJsonSerializableCompressedTokenStatusList() = JsonSerializableCompressedTokenStatusList(
            compressed = compressed,
            statusBitSize = statusBitSize,
            aggregationUri = aggregationUri,
        )
