...
fun CreatePresentationResult.toJsonPrimitive() = when (val presentationResult = this) {
    ...
    presentationResult.deviceResponse.serialize().encodeToString(Base64UrlStrict)
    )
}
