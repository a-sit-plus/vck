...
interface CwtStatusMechanismProvider : CwtStatusListStatusMechanismSpecification.StatusMechanismProvider {
    companion object {
        fun validate(status: CwtStatusMechanismProvider): Unit = status.run {
