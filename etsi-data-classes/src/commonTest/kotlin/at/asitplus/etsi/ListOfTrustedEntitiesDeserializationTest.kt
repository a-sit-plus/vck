...
val ListOfTrustedEntitiesDeserializationTest by testSuite {
    ...
    val pidProvidersWithAllMandatoryFields = """
          {
            "ListAndSchemeInformation": {
              "LoTEVersionIdentifier": 1,
              "LoTESequenceNumber": 4,
    ...
    """.trimIndent()
    val walletProvidersWithAllMandatoryFields = """
          {
            "ListAndSchemeInformation": {
              "LoTEVersionIdentifier": 1,
              "LoTESequenceNumber": 2,
    ...
    """.trimIndent()
    val wrpacProvidersWithAllMandatoryFields = """
          {
            "ListAndSchemeInformation": {
              "LoTEVersionIdentifier": 1,
              "LoTESequenceNumber": 2,
    ...
    """.trimIndent()
    val mdlProvidersWithAllMandatoryFields = """
          {
            "ListAndSchemeInformation": {
              "LoTEVersionIdentifier": 1,
              "LoTESequenceNumber": 2,
