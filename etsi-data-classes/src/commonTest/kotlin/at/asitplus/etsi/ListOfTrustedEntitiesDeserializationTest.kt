...
val ListOfTrustedEntitiesDeserializationTest by testSuite {
    ...
    testSuite("decode 1") {
        withData(
            "pidProviders" to pidProvidersOriginal,
            "walletProviders" to walletProvidersOriginal,
            "wrpacProviders" to wrpacProvidersOriginal,
            "mdlProviders" to mdlProvidersOriginal,
        ) {
