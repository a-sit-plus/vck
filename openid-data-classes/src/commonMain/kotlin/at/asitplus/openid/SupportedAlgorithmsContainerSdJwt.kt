...
data class SupportedAlgorithmsContainerSdJwt(
     ...
     */
    @Transient
    val sdJwtAlgorithms: Set<JwsAlgorithm>? = sdJwtAlgorithmStrings?.mapNotNull { it.toJwsAlgorithm() }?.toSet()
     ...
     */
    @Transient
    val kbJwtAlgorithms: Set<JwsAlgorithm>? = kbJwtAlgorithmStrings?.mapNotNull { it.toJwsAlgorithm() }?.toSet()
