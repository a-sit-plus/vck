...
//
    ...
    "Wallet Instance Attestation" {
        ...
        val parsed: WalletAttestationPayload = Json.decodeFromString(input)
        ...
        Json.decodeFromString<WalletAttestationPayload>(Json.encodeToString(parsed)) shouldBe parsed
    }
}
