...
class KeyBindingTests : FreeSpec({
    ...
    "Rqes Request with EU PID credential" - {
        ...
        "Hash of transaction data is not changed during processing" {
            ...
            val authenticationRequest = holderOid4vp.parseAuthenticationRequestParameters(cibaWalletTestVector).getOrThrow()
            authenticationRequest.parameters.transactionData.shouldNotBeEmpty().shouldNotBeNull()
            externalMapStore.put("iTGlKl-AJxmncWPbXHp2xy58bNy18wqZ4TR9EzhBl2R4ulxeTEO0VyWYR2qMDpCDV5JWeOxecTqcEJ61bFKrUg", authenticationRequest.parameters)
