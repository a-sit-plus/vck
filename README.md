...
| `openid-data-classes`  | OpenID data classes. **Only depends on `dif-data-classes`, `etsi-data-classes` and `csc-data-classes`** and can hence be used independently of VC-K!                                                                                                     |
