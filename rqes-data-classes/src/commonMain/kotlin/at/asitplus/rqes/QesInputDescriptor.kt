...
@Deprecated(
    "Module will be removed in the future", ReplaceWith(
        "InputDescriptor",
        imports = ["at.asitplus.dif.InputDescriptor"]
    )
)
...
@Serializable
@Deprecated(
    "Module will be removed in the future; Please switch to OpenId4VP QES Flow", ReplaceWith(
        "DifInputDescriptor",
        imports = ["at.asitplus.dif.DifInputDescriptor"]
    )
)
