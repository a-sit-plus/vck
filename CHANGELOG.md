...
Release 5.9.0 (unreleased):
 - Allow `SimpleAuthorizationService` to toggle usage of PAR and JAR via new `requirePushedAuthorizationRequests` and `requestObjectSigningAlgorithms` parameters
